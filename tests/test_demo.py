...
class TestDaily(unittest.TestCase):
    def test_call(self):
        daily = Daily(lat=51, lon=9, month=1, **{"angle": 0.1, "outputformat": "json"})
        ...
        self.assertTrue(daily.total_irradiance() == 968.89, "Not equal.")
...
class TestHourly(unittest.TestCase):
    def test_call(self):
        ...
        self.assertTrue(hourly._params == {"outputformat": "json"}, "Not equal.")
